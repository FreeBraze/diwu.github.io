...
<body>
  ...
  <div class="container">
      ...
      <div class="units-container">
        <div class="unit-item">
          ...
          <div class="unit-card" data-unit="5">
            <h3>Passion guides life choices</h3>
            <p>热爱，指引人生选择</p>
          </div>
        </div>
      </div>
    ...
    <div class="page unit-detail-page" id="unitDetailPage">
      ...
      <div class="unit-circle">
        <span id="currentUnit">Unit 5</span>
      </div>

      <div class="dropdown-area">
        <div class="dropdown" id="unitDropdown">Passion guides life choices</div>
      </div>
    ...
    <div class="page game-page" id="gamePage">
      ...
      <div class="game-controls">
        <div class="control-group">
          <div>当前单元: <span id="currentUnitDisplay">Unit 5</span></div>
  ...
  <script>
    const wordData = {
      5: [
        { english: "questionnaire", chinese: "n. [C] 调查问卷，调查表" },
        { english: "stripe", chinese: "n. [C] 条纹；条带" },
        { english: "striped", chinese: "a. 有条纹的" },
        { english: "infinity", chinese: "n. [U] 无限，无穷" },
        { english: "successor", chinese: "n. [C] 继任者；接班人" },
        { english: "antibiotic", chinese: "n. [C, usu. pl.] 抗生素；抗菌素" },
        { english: "vaccinate", chinese: "vt. 给… 接种疫苗；给… 打预防针" },
        { english: "cape", chinese: "n. [C] 披肩；斗篷；海角，岬" },
        { english: "crusader", chinese: "n. [C] 社会改革家" },
        { english: "cemetery", chinese: "n. [C] 墓地；公墓" },
        { english: "oppress", chinese: "vt. 压迫；镇压；使烦恼" },
        { english: "oppressed", chinese: "a. 受压迫的；受压的" },
        { english: "mastermind", chinese: "vt. 策划；组织；n. 出谋划策者，主谋" },
        { english: "malpractice", chinese: "n. [C, U] 玩忽职守；渎职" },
        { english: "lawsuit", chinese: "n. [C] 诉讼（非刑事案件）" },
        { english: "sue", chinese: "v. 起诉；控告" },
        { english: "humane", chinese: "a. 人道的；仁慈的" },
        { english: "parliamentary", chinese: "a. 议会的；国会的" },
        { english: "sideline", chinese: "n. [C] 副业；兼职；旁观者；置身事外" },
        { english: "revenge", chinese: "n. [U] 复仇；报复" },
        { english: "kit", chinese: "n. [C] 成套工具；成套设备" },
        { english: "chronicle", chinese: "vt. 载入编年史；记载；n. 编年史；年代记" },
        { english: "diagnose", chinese: "vt. 诊断；判断" },
        { english: "expectancy", chinese: "n. [U] 期待；期望" },
        { english: "stalk", chinese: "vt. 悄悄地跟踪；潜近" },
        { english: "sympathy", chinese: "n. [pl., U] 同情；同情心" },
        { english: "condolence", chinese: "n. [C, usu. pl.] 吊唁；慰问" },
        { english: "obituary", chinese: "n. [C] 讣告；讣闻" },
        { english: "specimen", chinese: "n. [C] 抽样；样品；标本" },
        { english: "gangster", chinese: "n. [C] 黑帮成员；犯罪团伙成员" },
        { english: "intrigue", chinese: "vt. 激起好奇心；迷住；n. 阴谋诡计" },
        { english: "intrigued", chinese: "a. 非常感兴趣的；深感兴趣的" },
        { english: "blunt", chinese: "a. 直言不讳的；不客气的；不锋利的" },
        { english: "cosmetics", chinese: "n. [pl.] 化妆品；美容品" },
        { english: "vapor", chinese: "n. [C, U] 蒸汽；水汽" },
        { english: "siege", chinese: "n. [C, U] 包围；围困；封锁" },
        { english: "boycott", chinese: "vt. 抵制；排斥；拒绝参加" },
        { english: "exert", chinese: "vt. 行使（权力）；施加（影响力）；运用（权威）" },
        { english: "secular", chinese: "a. 非宗教的；世俗的" },
        { english: "oath", chinese: "n. [C] 誓言；誓约；誓词" },
        { english: "leaflet", chinese: "n. [C] 散页印刷品；传单" },
        { english: "enclosure", chinese: "n. [C] 圈地；围场" },
        { english: "watchdog", chinese: "n. [C] 监督机构；监督人" },
        { english: "judicious", chinese: "a. 明智的；有见地的" },
        { english: "wrath", chinese: "n. [U] 愤怒；狂怒" },
        { english: "incur", chinese: "vt. 招致（不快之事）；遭受；蒙受；造成" },
        { english: "contract", chinese: "v. （使）收缩；（使）压缩；压紧；限制；约束" },
        { english: "turn up", chinese: "到达；来到；被找到" },
        { english: "put out", chinese: "发行；公告；制作；发表" },
        { english: "alert sb. to sth.", chinese: "提醒（某人）注意；引起（某人）重视" },
        { english: "lay siege to sth./sb.", chinese: "向… 展开攻势；围攻" },
        { english: "follow suit", chinese: "仿效；跟着做" },
        { english: "in the face of", chinese: "面对" },
        { english: "stand/stay/remain on the sidelines", chinese: "袖手旁观；置身事外" },
        { english: "get revenge (on sb.) for sth.", chinese: "报复；复仇" },
        { english: "appeal to", chinese: "恳请某人做…；呼吁某人做…" },
        { english: "on the sidelines", chinese: "不参与；旁观；置身事外" },
        { english: "Henry Spira", chinese: "亨利・斯皮拉（1927—1998，美国动物权利运动家）" },
        { english: "New York University", chinese: "纽约大学" }
      ]
    };
    ...
    const unitData = {
      5: {
        title: "Unit 5",
        topic: "Passion guides life choices",
        description: "热爱，指引人生选择"
      }
    };
